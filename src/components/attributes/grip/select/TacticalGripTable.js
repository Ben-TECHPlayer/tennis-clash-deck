...
function TacticalGripTable(){

    const ITEM_ID = "attributes/grip/database/TacticalGrip";
                ...
                <table className="tactical-grip">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            {renderSkillCell(14, '53', true)}
                            {renderSkillCell(15, '56', true)}
                        </tr>
                    </tfoot>
                </table>
            </div>
...
export default TacticalGripTable;
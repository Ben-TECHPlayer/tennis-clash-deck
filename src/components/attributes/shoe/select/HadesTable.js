...
function HadesTable(){
    ...
    const ITEM_ID = "attributes/shoe/database/Hades";
                ...
                <table className="the-hades-treads">
                    ...
                    <tbody>
                        <tr>
                            ...
                            {renderSkillCell(11, '44')}
                            {renderSkillCell(12, '47')}
                            {renderSkillCell(13, '51')}
                            {renderSkillCell(14, '55')}
                            {renderSkillCell(15, '58')}
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>

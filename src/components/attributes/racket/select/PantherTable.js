...
function PantherTable(){

    const ITEM_ID = "attributes/racket/database/Panther";
                ...
                <table className="the-panther">
                    ...
                    <tbody>
                        <tr>
                            ...
                            {renderSkillCell(5, '23')}
                            {renderSkillCell(6, '25')}

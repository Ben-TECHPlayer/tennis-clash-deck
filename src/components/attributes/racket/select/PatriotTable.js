...
function PatriotTable(){

    const ITEM_ID = "attributes/racket/database/Patriot";
                ...
                <table className="the-patriot">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            {renderSkillCell(4, '20', true)}
                            {renderSkillCell(5, '24', true)}
                            {renderSkillCell(6, '27', true)}
                            {renderSkillCell(7, '30', true)}
                            {renderSkillCell(8, '37', true)}
                            {renderSkillCell(9, '40', true)}
                            {renderSkillCell(10, '43', true)}

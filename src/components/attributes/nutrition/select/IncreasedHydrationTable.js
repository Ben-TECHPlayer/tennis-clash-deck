...
function IncreasedHydrationTable(){

    const ITEM_ID = "attributes/nutrition/database/IncreasedHydration";
                ...
                <table className="increased-hydration">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            {renderSkillCell(6, '15', true)}
                            {renderSkillCell(7, '21', true)}
                            {renderSkillCell(8, '22', true)}
                            {renderSkillCell(9, '25', true)}
                            {renderSkillCell(10, '28', true)}
                            {renderSkillCell(11, '31', true)}
                            {renderSkillCell(12, '34', true)}
                            {renderSkillCell(13, '36', true)}
                        </tr>
                    </tfoot>
                </table>
            </div>
...
export default IncreasedHydrationTable;
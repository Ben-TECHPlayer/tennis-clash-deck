...
function KyrgiosTable() {
    const ITEM_ID = "players/legends/database/Kyrgios";
        ...
        <div className="table-container">
            ...
            <table className="kyrgios">
                ...
                <tfoot>
                    <tr>
                        <th>Total Power</th>
                        {renderSkillCell(1, '32', true)}
                        {renderSkillCell(2, '39', true)}
                        {renderSkillCell(3, '47', true)}
                        {renderSkillCell(4, '55', true)}

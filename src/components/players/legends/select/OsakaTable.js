...
function OsakaTable() {
    const ITEM_ID = "players/legends/database/Osaka";
            ...
            <div className="table-container">
                <table className="osaka">
                    ...
                    <tfoot>
                        <tr>
                            <th>Total Power</th>
                            {renderSkillCell(1, '28', true)}
                            {renderSkillCell(2, '35', true)}
                            {renderSkillCell(3, '42', true)}
                            {renderSkillCell(4, '50', true)}
                            {renderSkillCell(5, '55', true)}
                            {renderSkillCell(6, '63', true)}
                            {renderSkillCell(7, '71', true)}
                            {renderSkillCell(8, '78', true)}

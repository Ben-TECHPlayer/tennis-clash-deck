...
function OmarTable() {
    const ITEM_ID = "players/champions/database/Omar";
            ...
            <table className="omar">
                ...
                <tfoot>
                    <tr>
                        ...
                        {renderSkillCell(7, '60', true)}
                        {renderSkillCell(8, '66', true)}
                        {renderSkillCell(9, '71', true)}
                        {renderSkillCell(10, '79', true)}
                        {renderSkillCell(11, '83', true)}
                        {renderSkillCell(12, '90', true)}
                        {renderSkillCell(13, '96', true)}
                        {renderSkillCell(14, '102', true)}
